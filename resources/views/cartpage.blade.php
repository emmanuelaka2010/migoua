                                ...
                                <div class="relative">
                                    ...
                                    <div class="product-cart-son clearfix">
                                        <div class="image-product-cart float-left center-vertical-image ">
                                            <a href="#"><img src="img/img_270x270/{{ $product->model->photo }}" alt="" /></a>
                                        </div>
                                        <div class="info-product-cart float-left">
                                            <p class="title-product title-hover-black"><a class="animate-default" href="#">{{ $product->name }}</a></p>
                                            <p class="clearfix price-product">  <span class="total-product-cart-son">(x{{ $product->qty }})</span> {{ $product->price }} F CFA</p>
                                        </div>
                                    </div>
                                    @endforeach
			...
			<div class="container">
				<div class="row relative">
					...
					<div class="col-md-8 col-sm-12 col-xs-12 relative left-content-shoping clear-padding-left">
                        <p class="title-shoping-cart">Votre panier d'achat</p>
                        @foreach (Cart::content() as $product)
                        <div class="relative full-width product-in-cart border no-border-l no-border-r overfollow-hidden">
                            ...
                            <img src="img/img_270x270/{{ $product->model->photo }}" alt="">
							</div>
							<div class="relative product-in-cart-col-2">
                            <p class="title-hover-black"><a href="{{ route('product', ['num' => $product->id,'prod' => str_replace(" ", "-", $product->name)]) }}" class="animate-default">{{ $product->name }}</a> x({{ $product->qty }})</p>
							</div>
							<div class="relative product-in-cart-col-3">
                            <a href="{{ route('cart.delete', ['id' => $product->rowId ]) }}"><span class="ti-close relative remove-product"></span></a>
								<p class="text-red price-shoping-cart">{{ $product->price }} F CFA</p>
							</div>
						</div>
                        @endforeach
						<aside class="btn-shoping-cart justify-content top-margin-default bottom-margin-default">
                        <a href="{{ route('index') }}" class="clear-margin animate-default">Continuer vos achats</a>
							<a href="#" class="clear-margin animate-default">Modifier votre panier</a>
						</aside>
					</div>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 right-content-shoping relative clear-padding-right">
						...
						<div class="full-width relative cart-total bg-gray  clearfix">
							<div class="relative justify-content bottom-padding-15-default border no-border-t no-border-r no-border-l">
								<p>Subtotal</p>
								<p class="text-red price-shoping-cart">{{ Cart::total() }} F CFA</p>
							</div>
