						...
						<div class=" relative clearfix">
							...
							<div class="col-md-7 col-sm-12 col-xs-12">
								<div class="top-title-modal border no-border-l no-border-r no-border-t bottom-padding-15-default">
									<p class="title-product-modal">{{ $product->name }}</p>
								...
								<p class="price-modal top-margin-15-default bottom-margin-15-default"><span class="price-old-modal">$700.00</span> <span class="text-red left-margin-15-default">{{ $product->prix }} F CFA</span></p>
							<p class="intro-product-modal">{{ $product->description }}Meet the iPhone X - the device that’s so smart that it responds to a tap, your voice, and even a glance. Elegantly designed with a large 14.73 cm (5.8) Super Retina screen and a durable front-and-back glass, this smartphone is designed to impress. What’s more, you can charge this iPhone wirelessly.</p>
