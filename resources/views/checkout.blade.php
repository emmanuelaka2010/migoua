			...
			<div class="container">
				<div class="row relative">
					<div class="full-width relative top-checkout-box overfollow-hidden top-margin-default">
						<div class="col-md-6 col-sm-12 col-xs-12 clear-padding-left left-top-checkout">
							<div class="full-width box-btn-top-click">
								<p>Returning customer? <a href="#" class="animate-default title-hover-red">Cliquez ici pour vous connecter</a></p>
								...
								<div class="relative">
									<form method="POST" action="{{ route('login') }}" class="form-placeholde-animate">
							            ...
							            <div class="relative justify-content form-login-checkout">
							            	<button type="submit" class="animate-default button-hover-red">Se connecter</button>
							            	<ul class="check-box-custom list-radius clear-margin clear-margin">
												<li>
													<label class="clear-margin">Se souvenir de moi
														<input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
					  									<span class="checkmark"></span>
					  								</label>
												</li>
											</ul>
							            	<a href="#" class="animate-default title-hover-red">Mot de passe oublié?</a>
							            </div>
									</form>
								</div>
							</div>
						...
						<div class="col-md-6 col-sm-12 col-xs-12 clear-padding-right right-top-checkout">
							<div class="full-width box-btn-top-click">
								<p>Avez-vous un coupon? <a href="#" class="animate-default title-hover-red">Cliquez ici pour entrer votre code</a></p>
							</div>
							<div class="relative coupon-box-checkout form-placeholde-animate top-margin-default">
					            ...
					            <button class="apply_coupon animate-default button-hover-red">Appliquer</button>
							</div>
						</div>
					</div>
					...
					<div class="col-md-8 col-sm-12 col-xs-12 relative left-content-shoping clear-padding-left">
						...
						<p class="title-shoping-cart">Details de l'achat</p>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 right-content-shoping relative clear-padding-right">
						...
						<div class="full-width relative overfollow-hidden">
							...
							<div class="relative clearfix full-width product-order-sidebar border no-border-t no-border-r no-border-l">
								...
								<p class="title-product top-margin-15-default animate-default title-hover-black"><a href="#">{{ $product->name }} x{{ $product->qty }}</a></p>
									<p class="price-product">{{ $product->price }} F CFA</p>
								</div>
							</div>
							@endforeach
						</div>
