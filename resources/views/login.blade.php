			...
			<div class="container">
				<div class="row relative">
					<div class="full-width relative top-checkout-box overfollow-hidden top-margin-default">
						<div class="col-md-8 col-sm-12 col-xs-12 clear-padding-left left-top-checkout">
							<div class="full-width box-btn-top-click">
                            <p>Vous n'avez pas de compte? <br><a href="{{ route('register_1') }}" class="animate-default title-hover-red">Cliquez ici pour créer un compte</a></p>
								<div class="relative">
						...
						{{-- <div class="col-md-6 col-sm-12 col-xs-12 clear-padding-right right-top-checkout">
							<div class="full-width box-btn-top-click">
								<p>Vous n'avez pas de compte? <a href="#" class="animate-default title-hover-red">Cliquez ici pour créer un compte</a></p>
							</div>
						</div> --}}
					</div>
				</div>
